...
class VacancySeeder extends Seeder
{
    public function run()
    {
        $items = [
            ...
            ['title'=>'IT Technical Support','description'=>'Act as the first contact with employees who need technical assistance via phone','status'=>'1'],
            ...
            ['title'=>'Media sales representatives,','description'=>'Develop new business by finding out who holds the advertising budget in a target organisation and arranging to speak to them Persuade clients to buy advertising space','status'=>'1'],
