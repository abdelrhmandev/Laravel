      ...
      <table class="table align-middle table-row-bordered fs-6 gy-5" id="{{ __($trans.'.plural') }}">         
        <thead>
          <tr class="text-start fw-bold fs-7 text-uppercase gs-0">
            ...
            <th class="w-300px">{{ __('country.singular') }}</th>                                
            <th class="text-primary w-200px">{{ __('admin.created_at') }}</th>
            <th class="text-end min-w-200px noExport">{{ __('admin.actions') }}</th>  
          </tr>
        </thead>
...
{ data: 'country_id', name: 'country_id',orderable: false}, // 2
