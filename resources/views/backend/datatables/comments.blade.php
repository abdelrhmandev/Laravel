    ...
    */
    function loadDatatable(tableId, RouteListing, dynamicColumns, StatusColumn = null, TitleColumnOrder = null) {
        ...
        var handleDeleteRows = () => {
            ...
            deleteButtons.forEach(d => {
                d.addEventListener('click', function(e) {
                    ...
                    const itemName = '<strong><u>' + parent.querySelectorAll('td')[TitleColumnOrder]
                        .innerText + '</u></strong>';
                    Swal.fire({
                        html: destroy.getAttribute("data-confirm-message") + ' ' +
                            itemName + '?',
                        icon: "warning",
                        ...
                        if (result.value) { // Yes Delete
                            $.ajax({
                                ...
                                success: function(response, textStatus, xhr) {
                                    Swal.fire({
                                        html: destroy.getAttribute(
                                            "data-deleting-selected-items"
                                            ) + ' ' + itemName + '',
                                        icon: "info",
                                        buttonsStyling: false,
                            ...
                            Swal.fire({
                                text: destroy.getAttribute(
                                    "data-not-deleted-message"),
                                icon: "error",
                                buttonsStyling: false,
                                confirmButtonText: destroy.getAttribute(
        ...
        var initToggleToolbar = function() {
            ...
            deleteSelected.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    buttonsStyling: false,
                    showLoaderOnConfirm: true,
                    confirmButtonText: destroyMultipleRouteId.getAttribute(
                        "data-confirm-button-text"),
                    cancelButtonText: destroyMultipleRouteId.getAttribute(
                        "data-cancel-button-text"),
                    customClass: {
                        confirmButton: "btn fw-bold btn-danger",
                        cancelButton: "btn fw-bold btn-active-secondary"
                    },
                    ...
                    if (result.value) { // Yes Delete
                        $.ajax({
                            ...
                            success: function(response, textStatus, xhr) {
                                Swal.fire({
                                    html: destroyMultipleRouteId.getAttribute(
                                    ...
                                    if (response["status"] == true) {
                                        Swal.fire({
                                            ...
                                            icon: "success",
                                            buttonsStyling: false,
                                            confirmButtonText: destroyMultipleRouteId
                                                .getAttribute(
                                                    "data-back-list-text"
                                                    ),
                                            customClass: {
                        ...
                        Swal.fire({
                            text: destroyMultipleRouteId.getAttribute(
                                "data-not-deleted-message"),
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: destroyMultipleRouteId.getAttribute(
        ...
        var toggleToolbars = function() {
            ...
            'tbody [class="form-check-input AA"][type="checkbox"]');
        ...
        var exportButtons = function() {
            ...
            const ExporteddocumentTitle = document.getElementById(tableId + '_export_menu').getAttribute(
                "data-export-file-title") + ' ' + jsDate.toString();
            const ExporteddocumentAlertMessage = document.getElementById(tableId + '_export_menu').getAttribute(
                "data-export-file-alert-msg");
