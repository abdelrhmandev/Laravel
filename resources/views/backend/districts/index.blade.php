...
{ data: 'area_id', name: 'area_id',orderable: false}, 
{ data: 'city_id', name: 'city_id',orderable: false}, 
{ data: 'country_id', name: 'country_id',orderable: false},
{ data: 'created_at',name :'created_at', type: 'num', render: { _: 'display', sort: 'timestamp', order: 'desc'}}, // 5
{ data: 'actions' , name : 'actions' ,exportable:false,orderable: false,searchable: false},    
];
KTUtil.onDOMContentLoaded(function () {
  loadDatatable('{{ __($trans.".plural") }}','{{ $redirectRoute }}',dynamicColumns,'5','1');
});
</script>
@stop
