<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
    ...
    <div class="px-7 py-5">
      ...
      <div class="mb-10">
        ...
        <!--end::Label-->
        <!--begin::Input-->
        <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-recipes-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
          <option></option>
      ...
      <div class="mb-10">
        ...
        <!--end::Label-->
        <!--begin::Options-->
        <div class="d-flex flex-column flex-wrap fw-semibold" data-kt-recipes-table-filter="status">
          <!--begin::Option-->
      ...
      <div class="d-flex justify-content-end">
        <button type="reset" class="btn btn-light btn-active-light-primary me-2" data-kt-menu-dismiss="true" data-kt-recipes-table-filter="reset">{{ __('site.reset') }}</button>
        <button type="submit" class="btn btn-primary" data-kt-menu-dismiss="true" data-kt-recipes-table-filter="filter">{{ __('site.apply') }}</button>
      </div>
      <!--end::Actions-->
    </div>
    <!--end::Content-->
