      ...
      <table class="table align-middle table-row-bordered fs-6 gy-5" id="{{ __($trans.'.plural') }}">         
        <thead>
          <tr class="text-start fw-bold fs-7 text-uppercase gs-0">
            ...
            <th class="w-500px">{{ __('permission.associated_roles') }}</th>
...
{ data: 'name', name: 'name',orderable: false}, // 1
{ data: 'associated_roles', name: 'associated_roles',orderable: false,searchable: false},
