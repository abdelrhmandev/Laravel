        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
          ...
          <tbody class="fw-semibold text-gray-600">
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <img src="/metronic8/demo7/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 9090</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
              ...
              <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                  ...
                  <div class="menu-item px-3">
                    <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="menu-link px-3">View</a>
                  </div>
                  <!--end::Menu item-->
                  <!--begin::Menu item-->
                  <div class="menu-item px-3">
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="visa">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 2856</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="mastercard">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 2829</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <img src="/metronic8/demo7/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 7239</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="visa">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 9211</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="american_express">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 4609</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="mastercard">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 7027</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="american_express">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 2062</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="visa">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 4917</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="visa">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 9341</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="mastercard">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 9825</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
            ...
            <tr>
              ...
              <!--begin::Name=-->
              <td>
                <a href="/metronic8/demo7/../demo7/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
              </td>
              <!--end::Name=-->
              <!--begin::Email=-->
              <td>
              ...
              <!--begin::Payment method=-->
              <td data-filter="american_express">
              <img src="/metronic8/demo7/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 9699</td>
              <!--end::Payment method=-->
              <!--begin::Date=-->
