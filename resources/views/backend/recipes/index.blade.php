  ...
  <div class="container-xxl" id="kt_content_container">
    ...
    <div class="card">
      ...
      <div class="card-body pt-0">
        <!--begin::Table-->
        <table class="d-none table align-middle table-row-dashed fs-6 gy-5" id="Xkt_recipes_datatable">
          <!--begin::Table head-->
          <thead>
            <!--begin::Table row-->
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_recipes_table">
          ...
          <tbody class="text-gray-600 fw-semibold">
            ...
            <tr>
              ...
              <!--begin::Status=-->
              <td>
                <div class="badge badge-light-warning">0</div>
              </td>
              <!--end::Status=-->
              <!--begin::Billing=-->
              <td>
              ...
              <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                  ...
                  <div class="menu-item px-3">
                    <a href="../../demo7/dist/apps/recipes/add.html" class="menu-link px-3">View</a>
                  </div>
                  <!--end::Menu item-->
                  <!--begin::Menu item-->
                  <div class="menu-item px-3">
                    <a href="../../demo7/dist/apps/recipes/add.html" class="menu-link px-3">Edit</a>
                  </div>
                  <!--end::Menu item-->
                  <!--begin::Menu item-->
                  <div class="menu-item px-3">
                    <a href="#" data-kt-recipes-table-filter="delete_row" class="menu-link px-3">Delete</a>
                  </div>
                  <!--end::Menu item-->
                </div>
                <!--end::Menu-->
