            ...
            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
              ...
              <div class="px-7 py-5" data-kt-subscription-table-filter="form">
                ...
                <div class="mb-10">
                  ...
                  <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Status" data-kt-subscription-order-filter="status">                    
                    <option></option>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
          ...
          <tbody class="text-gray-600 fw-semibold">
            <tr>
              ...
              <td data-kt-subscription-table-filter="order_id">
              ...
              <!--begin::Status=-->
              <td>
                <div class="badge badge-light-primary">Published</div>
              </td>
              <!--end::Status=-->
              <!--begin::Billing=-->
              <td>
                <span class="fw-bold">Auto-debit</span>
              </td>
              <!--end::Billing=-->
              <!--begin::Product=-->
              <td>Basic</td>
            ...
            <tr>
              ...
              <td data-kt-subscription-table-filter="order_id">
                <a href="../../demo7/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">139787</a>
              </td>
            ...
            <tr>
              ...
              <!--begin::Status=-->
              <td>
                <div class="badge badge-light-warning">Scheduled</div>
              </td>
              <!--end::Status=-->
              <!--begin::Billing=-->
              <td>
