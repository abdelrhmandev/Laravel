      ...
      <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
          ...
          <div class="d-flex align-items-center position-relative my-1">
            ...
            <!--end::Svg Icon-->
            <input type="text" data-kt-table-filter="search" class="form-control form-control-solid w-320px ps-15" placeholder="{{ __('site.search') }} ......" />
          </div>
          <!--end::Search-->
        </div>
        <!--begin::Card title-->
        ...
        <div class="card-toolbar">
          ...
          <div class="d-flex justify-content-end align-items-center d-none" data-kt-table-toolbar="selected">
            ...
            <button type="button" class="btn btn-danger" id="destroyMultipleroute" data-destroyMultiple-route = "{{ route('admin.recipes.destroyMultiple') }}" data-kt-table-select="delete_selected">{{ __('site.delete_selected') }}</button>
          </div>
          <!--end::Group actions-->
        </div>
        <!--end::Card toolbar-->
...
KTUtil.onDOMContentLoaded(function () {
  loadDatatable('{{ route('admin.recipes.index') }}',dynamicColumns);
});
</script>
