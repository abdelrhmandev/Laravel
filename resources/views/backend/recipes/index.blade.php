...
@section('content')
  ...
  <div class="container-xxl" id="kt_content_container">
      ...
      <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
          ...
          <div class="d-flex align-items-center position-relative my-1">
            ...
            <!--end::Svg Icon-->
            <input type="text" data-kt-recipe-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search recipes" />
          </div>
          <!--end::Search-->
        </div>
        <!--begin::Card title-->
        ...
        <div class="card-toolbar">
          ...
          <div class="d-flex justify-content-end" data-kt-recipe-table-toolbar="base">
            ...
            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
              ...
              <div class="px-7 py-5">
                ...
                <div class="mb-10">
                  ...
                  <!--end::Label-->
                  <!--begin::Input-->
                  <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-recipe-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
                    <option></option>
                ...
                <div class="mb-10">
                  ...
                  <!--end::Label-->
                  <!--begin::Options-->
                  <div class="d-flex flex-column flex-wrap fw-semibold" data-kt-recipe-table-filter="payment_type">
                    <!--begin::Option-->
                ...
                <div class="d-flex justify-content-end">
                  <button type="reset" class="btn btn-light btn-active-light-primary me-2" data-kt-menu-dismiss="true" data-kt-recipe-table-filter="reset">Reset</button>
                  <button type="submit" class="btn btn-primary" data-kt-menu-dismiss="true" data-kt-recipe-table-filter="filter">Apply</button>
                </div>
                <!--end::Actions-->
              </div>
              <!--end::Content-->
            ...
            <!--end::Export-->
            <!--begin::Add recipe-->
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_recipe">Add recipe</button>
            <!--end::Add recipe-->
          </div>
          <!--end::Toolbar-->
          <!--begin::Group actions-->
          <div class="d-flex justify-content-end align-items-center d-none" data-kt-recipe-table-toolbar="selected">
            <div class="fw-bold me-5">
            <span class="me-2" data-kt-recipe-table-select="selected_count"></span>Selected</div>
            <button type="button" class="btn btn-danger" data-kt-recipe-table-select="delete_selected">Delete Selected</button>
          </div>
          <!--end::Group actions-->
        </div>
        <!--end::Card toolbar-->
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_recipes_table">
          ...
          <tbody class="fw-semibold text-gray-600">
            ...
            <tr>
              ...
              <!--end::Checkbox-->
              <!--begin::Order ID=-->
              <td data-kt-recipe-table-filter="order_id">
                <a href="../../demo7/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13987</a>
              </td>
              <!--end::Order ID=-->
              <!--begin::Customer=-->
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo7/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Melody Macy</a>
                    <!--end::Title-->
                  </div>
                </div>
              </td>
              ...
              <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                  ...
                  <div class="menu-item px-3">
                    <a href="../../demo7/dist/apps/ecommerce/sales/details.html" class="menu-link px-3">View</a>
                  </div>
                  <!--end::Menu item-->
                  <!--begin::Menu item-->
                  <div class="menu-item px-3">
                  ...
                  <!--begin::Menu item-->
                  <div class="menu-item px-3">
                    <a href="#" class="menu-link px-3" data-kt-recipe-table-filter="delete_row">Delete</a>
                  </div>
                  <!--end::Menu item-->
                </div>
                <!--end::Menu-->
            ...
            <tr>
              ...
              <!--begin::Order ID=-->
              <td data-kt-recipe-table-filter="order_id">
                <a href="../../demo7/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13988</a>
              </td>
              <!--end::Order ID=-->
              <!--begin::Customer=-->
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo7/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">John Miller</a>
                    <!--end::Title-->
                  </div>
                </div>
              </td>
    ...
    <!--end::Card-->
    <!--begin::Modals-->
    <!--begin::Modal - recipes - Add-->
    
    <!--end::Modal - recipes - Add-->
