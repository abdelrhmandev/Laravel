...
@stop
@section('content')
{{-- https://preview.keenthemes.com/html/metronic/docs/forms/formvalidation/advanced --}}
    ...
    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
      ...
      <div class="card card-flush py-4">
        ...
        <div class="card-body text-center pt-0">
          ...
          <style>.image-input-placeholder { background-image: url({{ asset('assets/backend/media/svg/files/blank-image.svg')}}); } [data-theme="dark"] .image-input-placeholder { background-image: url('assets/media/svg/files/blank-image-dark.svg'); }</style>
