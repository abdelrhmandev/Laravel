      ...
      <table class="table align-middle table-row-bordered fs-6 gy-5" id="{{ __($trans.'.plural') }}">         
        <thead>
          <tr class="text-start fw-bold fs-7 text-uppercase gs-0">
            ...
            <th class="text-end w-150px noExport">{{ __('admin.actions') }}</th>  
          </tr>
        </thead>
...
{ data: 'translate.slug', name: 'translate.slug',orderable: false}, 
...
KTUtil.onDOMContentLoaded(function () {
  loadDatatable('{{ __($trans.".plural") }}','{{ $redirectRoute }}',dynamicColumns,'','1','4');
});
</script>
@stop
