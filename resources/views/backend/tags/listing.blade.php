<div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_4">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 4</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 03357008</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_5">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 5</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01119006</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_6">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 6</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 04547002</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_7">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 7</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01861006</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_8">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 8</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">267.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01980002</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_9">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 9</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">300.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 02680008</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_10">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 10</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 03483007</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_11">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 11</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 04300004</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_12">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 12</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">44.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01648002</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_13">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 13</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 04377007</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_14">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 14</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 02108006</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_15">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 15</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">290.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01495006</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_16">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 16</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01397001</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_17">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 17</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">81.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 03777003</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_18">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 18</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">40.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 02314007</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_19">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 19</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01397005</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_20">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 20</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">153.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 03761004</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_21">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 21</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">259.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 02989005</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_22">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 22</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 04736003</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_23">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 23</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">180.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01356007</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_24">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 24</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">207.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 02199004</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_25">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 25</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">14.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 04404007</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_26">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 26</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 04906001</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_27">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 27</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">284.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 04839006</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_28">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 28</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">113.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 04407007</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_29">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 29</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    <span data-kt-ecommerce-edit-order-filter="price">300.00</span></div>
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 02642002</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_30">
                  ...
                  <div class="ms-5">
                    <!--begin::Title-->
                    <a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 30</a>
                    <!--end::Title-->
                    <!--begin::Price-->
                    <div class="fw-semibold fs-7">Price: $
                    ...
                    <!--end::Price-->
                    <!--begin::SKU-->
                    <div class="text-muted fs-7">SKU: 01572003</div>
                    <!--end::SKU-->
                  </div>
                </div>
              </td>
  ...
  <div class="d-flex justify-content-end">
    <!--begin::Button-->
    <a href="../../demo6/dist/apps/ecommerce/catalog/products.html" id="kt_ecommerce_edit_order_cancel" class="btn btn-light me-5">Cancel</a>
    <!--end::Button-->
    <!--begin::Button-->
