    ...
    <div class="flex-column-fluid hover-scroll-y" data-kt-scroll="true" data-kt-scroll-activate="true"
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active show" id="kt_aside_nav_tab_projects" role="tabpanel">
                <!--begin::Wrapper-->
                @include('layouts.backend.aside.__tab-contents.__projects')
                <!--end::Wrapper-->
            </div>
            <!--end::Tab pane-->
            <!--begin::Tab pane-->
                    ...
                    <div id="kt_aside_menu_wrapper" class="menu-fit">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('page.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="{{ route('admin.pages.create') }}">
                                        ...
                                        <span class="menu-title">{{ __('page.create') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('post.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="{{ route('admin.posts.create') }}">
                                        ...
                                        <span class="menu-title">{{ __('post.create') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="{{ route('admin.posts.create') }}">
                                        ...
                                        <span class="menu-title">{{ __('category.all') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="{{ route('admin.posts.create') }}">
                                        ...
                                        <span class="menu-title">{{ __('tag.all') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('faq.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('career.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.careers.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('career.list') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.careers.create') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('career.apply') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('slide.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.slides.create') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('slide.create') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--exnd:Menu item-->
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.slides.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('slide.all') }}</span>
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('client.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="{{ route('admin.clients.create') }}">
                                        ...
                                        <span class="menu-title">{{ __('client.create') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('conatcts.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.contacts') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('conatcts.all') }}</span>
...
{{-- 
                        ...
                        <div class="menu-item pt-5">
                            <!--begin:Menu content-->
                            <div class="menu-content">
                                <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('city.all') }} -
                                    {{ __('area.all') }} - {{ __('district.all') }}</span>
                            </div>
                            <!--end:Menu content-->
                        </div>
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('city.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="{{ route('admin.cities.create') }}">
                                        ...
                                        <span class="menu-title">{{ __('city.create') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('area.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="{{ route('admin.areas.create') }}">
                                        ...
                                        <span class="menu-title">{{ __('area.create') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('district.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="{{ route('admin.districts.create') }}">
                                        ...
                                        <span class="menu-title">{{ __('district.create') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
...
--}}
                        ...
                        {{-- 
                            ...
                            <!--begin:Menu content-->
                            <div class="menu-content">
                                <span class="menu-heading fw-bold text-uppercase fs-7">Food / Health</span>
                            </div>
                            <!--end:Menu content-->
                        </div> 
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('recipe.all') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.recipes.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('recipe.all') }}</span>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.recipe-categories.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('recipe-category.index') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.recipe-categories.create') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('recipe-category.create') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.nutritions.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('nutrition.all') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                        ...
                        {{-- <div class="menu-item pt-5">
                            <!--begin:Menu content-->
                            <div class="menu-content">
                                <span class="menu-heading fw-bold text-uppercase fs-7">E-SHOP</span>
                            </div>
                            <!--end:Menu content-->
                        </div> 
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo7/dist/apps/ecommerce/catalog/categories.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo7/dist/apps/ecommerce/catalog/add-product.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo7/dist/apps/ecommerce/catalog/add-category.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo7/dist/apps/ecommerce/reports/view.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo7/dist/apps/ecommerce/reports/sales.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo7/dist/apps/ecommerce/reports/returns.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo7/dist/apps/ecommerce/reports/customer-orders.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo7/dist/apps/ecommerce/reports/shipping.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">Attriubutes</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <!--end:Menu link-->
                                    <!--begin:Menu sub-->
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link"
                                                ...
                                                <span class="menu-title">All Attriubutes</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link"
                                                ...
                                                <span class="menu-title">Create Attriubute</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                        ...
                        <div class="menu-item pt-5">
                            <!--begin:Menu content-->
                            <div class="menu-content">
                                <span class="menu-heading fw-bold text-uppercase fs-7">Medical</span>
                            </div>
                            <!--end:Menu content-->
                        </div>
            ...
            <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
                <!--begin::Subscription-->
                @include('layouts.backend.aside.__tab-contents.__subscription')
                <!--end::Subscription-->
            </div>
            <!--end::Tab pane-->
            <!--begin::Tab pane-->
            <div class="tab-pane fade" id="kt_aside_nav_tab_tasks" role="tabpanel">
                <!--begin::Tasks-->
                @include('layouts.backend.aside.__tab-contents.__tasks')
                <!--end::Tasks-->
            </div>
            <!--end::Tab pane-->
            <!--begin::Tab pane-->
                ...
                <div class="mx-5">
                    ...
                    <div class="mb-12">
                        ...
                        <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo7/dist/widgets/lists.html"
                                    class="fw-bold text-gray-800 text-hover-primary fs-6">Group lunch celebration</a>
                        ...
                        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo7/dist/widgets/lists.html"
                                    class="fw-bold text-gray-800 text-hover-primary fs-6">Navigation optimization</a>
                        ...
                        <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo7/dist/widgets/lists.html"
                                    class="fw-bold text-gray-800 text-hover-primary fs-6">Humbert Bresnen</a>
                        ...
                        <div class="d-flex align-items-center bg-light-info rounded p-5 mb-7">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo7/dist/widgets/lists.html"
                                    class="fw-bold text-gray-800 text-hover-primary fs-6">Air B & B - Real Estate</a>
                        ...
                        <div class="d-flex align-items-center bg-light-primary rounded p-5 mb-7">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo7/dist/widgets/lists.html"
                                    class="fw-bold text-gray-800 text-hover-primary fs-6">B & Q - Food Company</a>
                        ...
                        <div class="d-flex align-items-center bg-light-danger rounded p-5">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo7/dist/widgets/lists.html"
                                    class="fw-bold text-gray-800 text-hover-primary fs-6">Nexa - Next generation</a>
            ...
            <div class="tab-pane fade" id="kt_aside_nav_tab_authors" role="tabpanel">
                <!--begin::Authors-->
                @include('layouts.backend.aside.__tab-contents.__authors')
                <!--end::Authors-->
            </div>
            <!--end::Tab pane-->
        </div>
